...
export const DEFAULT_CONFIGURATOR_CONFIG: ConfiguratorConfig = {
  ...
  // verejny konfigurator - zjednoduseny cenik (port z Bolt prototypu)
  public: {
    prices: {
    ...
    subsidies: [
      { sector: 'heating', label: 'Vytápění (NZÚ)', description: 'Dotace na tepelné čerpadlo - Nová zelená úsporám', amount: 80000, enabled: false },
      { sector: 'air', label: 'Vzduchotechnika (NZÚ)', description: 'Dotace na rekuperaci - Nová zelená úsporám', amount: 100000, enabled: false },
      { sector: 'energy_basic', label: 'Fotovoltaika - základní (NZÚ)', description: 'Dotace na FVE základní', amount: 45000, enabled: false },
      { sector: 'energy_optimum', label: 'Fotovoltaika - optimum (NZÚ)', description: 'Dotace na FVE s baterií', amount: 160000, enabled: false },
      { sector: 'energy_max', label: 'Fotovoltaika - maximum (NZÚ)', description: 'Dotace na FVE max', amount: 160000, enabled: false },
    ],
    showLivePrices: false,
    showResultPrices: true,
  },
};

export const PUBLIC_PRICE_LABELS: Record<string, string> = {
  heatPumpBase: 'Tepelné čerpadlo (základ)',
  floorHeatingPerM2: 'Podlahové topení (Kč/m²)',
  radiatorPerPcs: 'Radiátor (ks)',
  tank: 'Akumulační nádrž',
  electroBoiler: 'Elektrokotel',
  solidFuelBoiler: 'Kotel na tuhá paliva',
  waterBase: 'Voda a odpady (základ)',
  waterSoftener: 'Změkčovač vody',
  smartValve: 'Smart Valve',
  circulationPump: 'Cirkulace TUV',
  recuperationBase: 'Rekuperace (základ)',
  recuperationPerM2: 'Rekuperace (Kč/m²)',
  recuperationCooling: 'Chlazení k rekuperaci',
  fveBasic: 'FVE základní (3-4 kWp)',
  fveOptimum: 'FVE optimum (6-8 kWp + baterie)',
  fveMax: 'FVE maximum (10+ kWp)',
  smartHomeBase: 'Loxone (základ)',
  smartPerM2: 'Loxone (Kč/m²)',
  smartBasic: 'Základní smart home',
  electroPerM2: 'Elektroinstalace (Kč/m²)',
  alarmPrep: 'Alarm - příprava',
  alarmBase: 'Alarm Jablotron (základ)',
  alarmPerM2: 'Alarm (Kč/m² ÷ 20)',
  cameraPrep: 'Kamery - příprava',
  cameraFull: 'Kamerový systém komplet',
  loxoneFeatureBase: 'Loxone funkce (ks)',
};
