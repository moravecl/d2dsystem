  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          <h2 className="text-xl font-bold text-white mb-2">Prirazeni produktu</h2>
          <p className="text-sm text-slate-400">
            Priradte produkty z katalogu ke schematickym znackam umistenym v navrhu.
          </p>
        </div>
      ...
      <div className="bg-navy-800/50 rounded-2xl border border-white/10 overflow-hidden mb-6">
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-white">Aktualni navrh</h3>
            ...
            {isComplete && (
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                ...
                <span className="text-xs font-bold text-emerald-400">Kompletni</span>
              </div>
            )}
            {hasUnassigned && (
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/30">
                ...
                <span className="text-xs font-bold text-amber-400">
                  {stats.unassignedCount} neprirazeno
                </span>
              </div>
            )}
          </div>
            ...
            {stats.inheritedCount > 0 && (
              <div className="mt-3 flex items-center gap-2 p-2 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <span className="text-xs text-blue-300">
                  {stats.inheritedCount} prvku dedi prirazeni z projektu nebo mistnosti
                </span>
              </div>
            )}
          </div>
        ...
        >
          ...
          <div className="flex-1">
            <div className="text-sm font-bold text-white">Priradit produkty</div>
            <div className="text-xs text-slate-400">
              Priradte konkretni produkty ke schematickym znackam
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-slate-500">Zkontrolujte vyber</div>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm font-bold text-white">Nabidky</div>
      ...
      {!hasElements && (
        <div className="text-center py-8 px-4 rounded-2xl border border-white/10 bg-white/[0.02]">
          ...
          <h3 className="text-sm font-bold text-white mb-1">Zadne schematicke prvky</h3>
          <p className="text-xs text-slate-400 mb-4">
            Nejprve pridejte prvky ve schematickem navrhu
          </p>
          <button
